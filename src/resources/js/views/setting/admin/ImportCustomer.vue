...
<template>
  <div>
    ...
    <p class="mt-4">ファイルの形式はcsvファイルのみです。</p>

    <p>データの形式は以下の形式ファイルのみインポートが可能です。</p>

    <p>
      都道府県名、市区町村名、町域名、住所のアドレス(ハイフン区切り)、建物名、部屋番号、会社名、姓、名、置き配場所(、区切り),
      備考,不在時に置き配(有効にするなら1を入力)Amazonのみ(有効にするなら1を入力)
    </p>

    <p>該当するデータがない場合は空欄にしてください。</p>

    <p>例）千葉県, 船橋市, 湊町, 2-10-25, 船橋市役所, , , ,山田, 太郎, 玄関、その他, 7階, 1 1,ドアの前に置く</p>
